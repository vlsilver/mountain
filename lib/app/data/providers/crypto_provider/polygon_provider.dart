...
class PolygonProvider extends GetConnect {
  /// QuickSwap: Router
  ...
  static const String contractWrapMATIC =
  ...
  void initData(BlockChainModel blockChain) {
    ...
    _httpUrl = 'https://rpc-mainnet.maticvigil.com';
    _wssUrl = blockChain.nodeWss;
    _wssUrl = 'wss://rpc-mainnet.maticvigil.com/ws';
  ...
  Future<dynamic> postApi({
    required EnumPolygonMethod method,
    ...
    if (response.statusCode == 200 && response.body['error'] == null) {
      ...
      throw response.body['error'] ?? 'Polygon RPC failure';
    }
  }
  ...
  Future<String> getChainId() async {
    try {
      final result = await postApi(
        method: EnumPolygonMethod.eth_chainId,
        params: [],
      );
  ...
  Future<BigInt> getGasLimitToRevokeApproveTransactionToken({
    required String addressContract,
    ...
    try {
      ...
      final contract = DeployedContract(
          ContractAbi.fromJson(abiBEP20, 'PERC20 Token'), contractAddr);
  ...
  // Future<BigInt> getGasLimitToCreateTokenPERC2020({
  ...
  Future<BigInt> getGasPrice() async {
    try {
      final result = await postApi(
        method: EnumPolygonMethod.eth_gasPrice,
        params: [],
      );
  ...
  Future<BigInt> getBalance({required String address}) async {
    final result = await postApi(
        method: EnumPolygonMethod.eth_getBalance,
        params: [
          address,
          EnumPolygonDefaultBlock.latest.toString().split('.')[1]
        ]) as String;
    return BigInt.parse(result == '0x0' ? '0' : result.substring(2), radix: 16);
  }

  Future<BigInt> getBalanceOfPERC20({
    ...
    final contract = DeployedContract(
        ContractAbi.fromJson(abiERC20, 'PERC20 Token'), contractAddr);
  ...
  Future<String> getTransactionCount({required String address}) async {
    final result = await postApi(
      method: EnumPolygonMethod.eth_getTransactionCount,
      params: [
        address,
        EnumPolygonDefaultBlock.pending.toString().split('.')[1]
      ],
    );
    return AppFormat.dropHexString(hexString: result);
  }
  ...
  Future<String> sendTransaction({required String data}) async {
    final result = await postApi(
        method: EnumPolygonMethod.eth_sendRawTransaction, params: [data]);
    return result;
  }

  Future<String> sendTransactionPERC20({
    required String addressContract,
    required String addrsassRecieve,
  ...
  Future<List<dynamic>> getTransactionsOfPERC20(
    ...
    final query = {
      ...
      'address': address,
      'startblock': '0',
      'endblock': EnumPolygonDefaultBlock.latest.toString().split('.')[1],
      'page': '1',
      'offset': '25',
      'sort': 'desc',
      'apikey': 'W47G388V58DW5ICUQE1QTVV13TJGIXNUHT',
    };
  ...
  Future<List<dynamic>> getTransactions({
    ...
    try {
      final query = {
        ...
        'offset': '${offset ?? 25}',
        'sort': 'desc',
        'apikey': 'F2PAHW6AQATY81E143FGZ58TA5DYPN2YS4',
      };
      final data = await getApi(query: query);
      return data;
    } catch (exp) {
  ...
  Future<CoinModel> getTokenModelPERC20Info(
  ...
  // Future<String> createNewTokenPERC20({
  //   required String name,
  //   required String symbol,
  //   required BigInt totalSuply,
  //   required String addressContract,
  ...
  //       'txhash': hash,
  //       'apikey': '9NN8FPJI88JU37G1CZYM8M9DT712KSN6UV',
  //     };
  //     final data = await getApi(query: query);
  //     return data;
  //   } catch (exp) {
  ...
  Future<String> sendTransactionRevokePERC20({
    required String addressContract,
  ...
  Future<Map<String, dynamic>?> getTransactionInformation(
    ...
    final result = await postApi(
        method: EnumPolygonMethod.eth_getTransactionByHash, params: [hash]);
    return result;
  }

  Future<Map<String, dynamic>?> getTransactionReceiptByHash(String hash) async {
    final result = await postApi(
        method: EnumPolygonMethod.eth_getTransactionReceipt, params: [hash]);
    return result;
  }

  Future<String> swapExactMATICForTokensSupportingFeeOnTransferTokens({
    ...
    final wrapMATICContract = EthereumAddress.fromHex(contractWrapMATIC);
    ...
    final chainId = int.parse(chainIdHexString, radix: 16);
    final contract = DeployedContract(
        ContractAbi.fromJson(abiBEP20, 'PERC20 Token'), contractAbi);
    final swapFunction =
    ...
    final result = await _client.sendTransaction(
      ...
      Transaction.callContract(
          ...
          parameters: [
            BigInt.from(0),
            [wrapMATICContract, tokenContract],
            receiverAddr,
  ...
  Future<BigInt> getGasLimitToSwapExactMATICForTokens({
    required String tokenContractTo,
    required String addressSender,
    required String addrsassRecieve,
    required BigInt amount,
  ...
  Future<String> swapExactTokensForMATICSupportingFeeOnTransferTokens({
    ...
    final result = await _client.sendTransaction(
      ...
      Transaction.callContract(
          ...
          parameters: [
            amount,
            BigInt.from(0),
            [tokenContract, wrapMATICContract],
            receiverAddr,
            BigInt.from((DateTime.now().millisecondsSinceEpoch / 1000).round() +
                20 * 60)
          ],
  ...
  Future<BigInt> getGasLimitSwapExactTokensForMATIC({
    required String tokenContractFrom,
    required String addressSender,
    required String addrsassRecieve,
    required BigInt amount,
  ...
  Future<String> swapExactTokensForTokensSupportingFeeOnTransferTokens({
    ...
    final path = [];
    if (tokenContractTo.toLowerCase() == contractWrapMATIC.toLowerCase() ||
        tokenContractFrom.toLowerCase() == contractWrapMATIC.toLowerCase()) {
      path..add(tokenFrom)..add(tokenSwap);
    } else {
      path..add(tokenFrom)..add(wrapMATICContract)..add(tokenSwap);
    }
    final result = await _client.sendTransaction(
      credentials,
      Transaction.callContract(
  ...
  Future<double> getAmountsOut({
    ...
    try {
      ...
      final tokenFrom = tokenContractFrom.isNotEmpty
          ...
          : EthereumAddress.fromHex(contractWrapMATIC);
  ...
  Future<String> getPairFactory({
    ...
    final contractFrom = EthereumAddress.fromHex(
        tokenFrom.isEmpty ? contractWrapMATIC : tokenFrom);
    final contractTo = EthereumAddress.fromHex(
      tokenTo.isEmpty ? contractWrapMATIC : tokenTo,
    );
    final contract = DeployedContract(
  ...
  Future<String> getLpTokenA({required String tokenLP}) async {
    ...
    final contractLP = EthereumAddress.fromHex(tokenLP);
    final contract =
        DeployedContract(ContractAbi.fromJson(abi, 'PERC20 Token'), contractLP);
  ...
  Future<BigInt> getGasLimitAddLiquidityMATIC({
    ...
    final receiverAddr = EthereumAddress.fromHex(addrsassRecieve);
    final contract = DeployedContract(
        ContractAbi.fromJson(abiSwap, 'PERC20 Token'), contractAbi);
  ...
  Future<String> addLiquidityMATIC({
    required String token,
    required String privateKey,
    required String addressSender,
    required String addrsassRecieve,
    ...
    final chainId = int.parse(chainIdHexString, radix: 16);
    final contract = DeployedContract(
        ContractAbi.fromJson(abiKRC20, 'PERC20 Token'), contractAbi);
    final addLiquidityFunction = contract.function('addLiquidityETH');
    final result = await _client.sendTransaction(
      credentials,
      Transaction.callContract(
  ...
  Future<String> addLiquidityToken({
    ...
    final chainId = int.parse(chainIdHexString, radix: 16);
    final contract = DeployedContract(
        ContractAbi.fromJson(abi, 'PERC20 Token'), contractAbi);
    final addLiquidityFunction = contract.function('addLiquidity');
    final result = await _client.sendTransaction(
      credentials,
      Transaction.callContract(
  ...
  Future<BigInt> getBalanceOfLPToken({
    ...
    final abi = Get.find<SettingService>().abiLPToken;
    final contract = DeployedContract(
        ContractAbi.fromJson(abi, 'PERC20 Token'), contractAddr);
    final balanceFunction = contract.function('balanceOf');
    final balance = await _client.call(
        contract: contract,
        function: balanceFunction,
  ...
  Future<BigInt> getGasLimitRemoveAddLiquidityMATIC({
    required String token,
    required String addressSender,
    required String addrsassRecieve,
  ...
  Future<String> removeAdddLiquidityMATIC({
    required String token,
    required String addressSender,
    required String addrsassRecieve,
    required BigInt amountTokenLP,
