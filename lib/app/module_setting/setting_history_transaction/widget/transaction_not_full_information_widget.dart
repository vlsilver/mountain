...
class TransactionNotFullInformationWidget extends StatelessWidget {
  const TransactionNotFullInformationWidget({
    Key? key,
                          ...
                          Flexible(
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  transaction.valueFormatCurrencyByCoinModel(
                                      coinModel),
                                  maxLines: 1,
                                  overflow: TextOverflow.ellipsis,
                                  textAlign: TextAlign.end,
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              transaction
                                  .totalFormatCurrencyByCoinModel(coinModel),
                              textAlign: TextAlign.end,
                              style: AppTextTheme.bodyText1.copyWith(
                                  color: AppColorTheme.error,
                                  fontWeight: FontWeight.bold),
