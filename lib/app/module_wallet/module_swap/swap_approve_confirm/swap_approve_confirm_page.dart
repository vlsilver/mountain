...
import 'swap_approve_confirm_controller.dart';

class SwapApproveConfirmPage extends GetView<SwapApproveConfirmController> {
  const SwapApproveConfirmPage({Key? key, this.height}) : super(key: key);
              ...
              child: Column(
                children: [
                  _ItemInformationAddressWidget(
                    name: controller.swapController.addressSender.name,
                    informationAddress: controller.swapController.addressSender
                  ...
                  _ItemInformationAddressWidget(
                    name: BlockChainModel.getNameRouterApprove(
                        controller.swapController.blockChainModel.id),
...
class _GroupInformationAmount extends GetView<SwapApproveConfirmController> {
  const _GroupInformationAmount({
    Key? key,
  }) : super(key: key);
