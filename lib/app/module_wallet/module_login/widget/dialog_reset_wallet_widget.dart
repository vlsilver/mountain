...
class DialogResetWalletWidget extends GetView<LoginController> {
  const DialogResetWalletWidget({Key? key}) : super(key: key);
  @override
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(height: AppSizes.spaceLarge),
                    GlobalButtonWidget(
                        name: 'dialogBtnStr'.tr,
                        type: ButtonType.ERROR,
                        onTap: () {
                          controller.handleButtonDeleteWalletOnTap();
                        }),
                    SizedBox(height: AppSizes.spaceLarge),
                  ],
                ),
