...
class RemoveAddLiquidityConfirmPage
    extends GetView<RemoveAddLiquidityController> {
  const RemoveAddLiquidityConfirmPage({Key? key, this.height})
      : super(key: key);
              ...
              Expanded(
                child: Row(
                  ...
                  children: [
                    Expanded(
                      child: Text(
                        controller.addressSender.addressFormat,
                        maxLines: 1,
              ...
              Expanded(
                child: Row(
                  ...
                  children: [
                    Expanded(
                      child: Text(
                        controller.addLiquidityModel.tokenLP
                            .valueWithSymbol(controller.amountDouble),
                        maxLines: 1,
                        overflow: TextOverflow.ellipsis,
                        textAlign: TextAlign.end,
                        style: AppTextTheme.bodyText1
                    ...
                    Text(
                      controller.addLiquidityModel.tokenLP
                          .currencyOfValue(controller.amountDouble),
                      maxLines: 1,
                      overflow: TextOverflow.ellipsis,
                      textAlign: TextAlign.end,
                      style: AppTextTheme.bodyText1
              ...
              Expanded(
                child: Text(
                  TransactionData.totalFormatByData(
                    coinModel: controller.addLiquidityModel.tokenLP,
                    fee: controller.fee,
                    amount: controller.addLiquidityModel.tokenLP.amount,
                  ),
                  textAlign: TextAlign.end,
                  style: AppTextTheme.bodyText1.copyWith(
                      color: AppColorTheme.error, fontWeight: FontWeight.bold),
