...
import 'add_liquidity_approve_confirm_controller.dart';

class AddLiquidityApproveConfirmPage
    extends GetView<AddLiquidityApproveConfirmController> {
  const AddLiquidityApproveConfirmPage({Key? key, this.height})
      : super(key: key);
              ...
              child: Column(
                children: [
                  _ItemInformationAddressWidget(
                    name: controller.addLiquidityController.addressSender.name,
                    informationAddress: controller.addLiquidityController
                        .addressSender.addreesFormatWithRoundBrackets,
                    title: 'global_from'.tr,
                  ),
                  const SizedBox(height: AppSizes.spaceSmall),
                  _ItemInformationAddressWidget(
                    name: BlockChainModel.getNameRouterApprove(
                        controller.addLiquidityController.blockChainModel.id),
          ...
          Row(
            ...
            children: [
              ...
              Expanded(
                child: Text(
                  TransactionData.totalFormatByData(
                    coinModel: controller.addLiquidityController.coinModelB,
                    fee: controller.addLiquidityController.fee,
                    amount: 0.0,
                  ),
                  textAlign: TextAlign.end,
