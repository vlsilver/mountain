...
class IDOApproveConfirmPage extends GetView<IDODepositController> {
  const IDOApproveConfirmPage({Key? key, this.height}) : super(key: key);
              ...
              child: Column(
                children: [
                  _ItemInformationAddressWidget(
                    name: controller.addressModel.name,
                    informationAddress:
                        controller.addressModel.addreesFormatWithRoundBrackets,
